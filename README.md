...
> Universal memoize decorator with TTL

[![PyPI version](https://badge.fury.io/py/memoize-it.svg)](https://pypi.org/project/memoize-it/)
...
result = it("Hello World")

# Example 2: Batch processing
from memoize_it import batch
